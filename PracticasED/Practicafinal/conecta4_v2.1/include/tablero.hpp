...
public:
    ...
    Tablero& operator=(const Tablero& derecha);
		...
		/**
		 * @breif Operador de igualdad. Devuelve true en caso de que ambos tableros
		 *      sean iguales
		 * @param tab : Tablero con el que se compara
		 * @return Devuelve true si son iguales y false y son distintos
		 */
		bool operator==(const Tablero& tab);
